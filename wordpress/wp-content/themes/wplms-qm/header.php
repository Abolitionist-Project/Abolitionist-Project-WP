    ...
    <body <?php body_class($layout); ?>>
        <div id="global" class="global">
            ...
            <div class="pusher">
                ...
                ?>
                <div id="headertop" class="<?php if (isset($fix) && $fix) {
                    echo 'fix';
                } ?>">
                    <div class="container">
                        <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-10">
                                ...
                                <div class="searchFormForResult" style="display:none;"> 
                                    <div class="fieldsContainer">  
                                        <input id="searchVariableForResultHidden" type="hidden">
                                        <input id="searchVariableForResult" class="searchVariableForResult" type="text" placeholder="Enter your search terms...">
                                        <button class="searchResult" id="searchResultButton">
                                            <i class="icon-search-2 varSearchIcon"></i>
                                        </button>
                                    </div>
                                    <ul id="variablePickerListForResult" class="variablePickerListForResult">
                                        <!-- Variables go here -->
                                    </ul>   
                                </div>
                            </div>
