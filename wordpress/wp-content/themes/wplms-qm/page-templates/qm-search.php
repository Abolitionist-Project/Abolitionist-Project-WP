...
wp_enqueue_style("qm-search-result", $stylesheet_dir . "/css/qm-search-result.css");
...
wp_enqueue_style("qm-search-result", $stylesheet_dir . "/css/qm-search-result.css");
wp_enqueue_script("angular", $stylesheet_dir . "/js/libs/angular.min.js");
wp_enqueue_script("qm-search-result", $stylesheet_dir . "/js/qm-search-result.js", "qm-sdk", false, true);
...
<div class="searchFormByDefault">
    ...
    <div>        
            ...
            <input id="searchVariable" class="searchVariable" type="text" placeholder="Enter a medication, food supplement or anything else...">
            <input id="askQuantimodo" class="searchsubmit" type="button" value="Ask QuantiModo">
            </div>
            <ul id="variablePickerList" class="variablePickerList">
				<!-- Variables go here -->
			</ul>
            </p>  
    </div>    
...
<?php include 'qm-search-result.php'; ?>
