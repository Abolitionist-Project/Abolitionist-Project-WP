...
Quantimodo = function() 
{
	...
	return {
		...
		postVariableUserSettings: function(measurements, f) { POST('variableUserSettings', ['variable'], measurements, f); },
                ...
                getPublicCorrelationsWithEffect: function(params, f) { GET('public/correlations', ['effect'], params, f); },
                getPublicCorrelationsWithCause: function(params, f) { GET('public/correlations', ['cause'], params, f); },
